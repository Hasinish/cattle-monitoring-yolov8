...
def parse_args():
    parser = argparse.ArgumentParser(description="Run YOLOv8 segmentation prediction on cattle frames.")
    parser.add_argument("--weights", required=True, help="Path to trained segmentation best.pt.")
    ...
    parser.add_argument("--name", default="seg_yolov8s_01_labels", help="Output run name.")
